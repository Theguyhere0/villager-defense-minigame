...
public class Kit {
    ...
    public Kit(String name, Type kitType, String ID, Material buttonMaterial) {
        this.name = name;
    ...
    public static Kit none() {
        Kit kit = new Kit(LanguageManager.names.none, Type.NONE, "none", Material.LIGHT_GRAY_CONCRETE);
    ...
    public static Kit orc() {
        Kit kit = new Kit(LanguageManager.kits.orc.name, Type.GIFT, "orc", Material.STICK);
    ...
    public static Kit farmer() {
        Kit kit = new Kit(LanguageManager.kits.farmer.name, Type.GIFT, "farmer", Material.CARROT);
    ...
    public static Kit tailor() {
        ...
        kit.addItems(1, new ItemStack[]{
                Sword.create(VDItem.Tier.T0, Sword.SwordType.TIERED),
                ItemFactory.removeLastLore(ItemFactory.rename(Helmet.create(VDItem.Tier.T1),
                        new ColoredMessage(ChatColor.GREEN, LanguageManager.kits.tailor.items.helmet).toString())),
                ItemFactory.removeLastLore(ItemFactory.rename(Chestplate.create(VDItem.Tier.T1),
                        new ColoredMessage(ChatColor.GREEN, LanguageManager.kits.tailor.items.chestplate).toString())),
                ItemFactory.removeLastLore(ItemFactory.rename(Leggings.create(VDItem.Tier.T1),
                        new ColoredMessage(ChatColor.GREEN, LanguageManager.kits.tailor.items.leggings).toString())),
                ItemFactory.removeLastLore(ItemFactory.rename(Boots.create(VDItem.Tier.T1),
    ...
    public static Kit trader() {
        Kit kit = new Kit(LanguageManager.kits.trader.name, Type.GIFT, "trader", Material.EMERALD);
    ...
    public static Kit summoner() {
        Kit kit = new Kit(LanguageManager.kits.summoner.name, Type.GIFT, "summoner",
        ...
        kit.addItems(3, new ItemStack[]{Sword.create(VDItem.Tier.T0, Sword.SwordType.TIERED)});
    ...
    public static Kit phantom() {
        Kit kit = new Kit(LanguageManager.kits.phantom.name, Type.GIFT, "phantom", Material.PHANTOM_MEMBRANE);
    ...
    public static Kit mage() {
        Kit kit = new Kit(LanguageManager.kits.mage.name, Type.ABILITY, "mage", Material.FIRE_CHARGE);
    ...
    public static Kit ninja() {
        Kit kit = new Kit(LanguageManager.kits.ninja.name, Type.ABILITY, "ninja", Material.CHAIN);
    ...
    public static Kit templar() {
        Kit kit = new Kit(LanguageManager.kits.templar.name, Type.ABILITY, "templar", Material.GOLDEN_SWORD);
    ...
    public static Kit warrior() {
        Kit kit = new Kit(LanguageManager.kits.warrior.name, Type.ABILITY, "warrior",
    ...
    public static Kit knight() {
        Kit kit = new Kit(LanguageManager.kits.knight.name, Type.ABILITY, "knight", Material.SHIELD);
    ...
    public static Kit priest() {
        Kit kit = new Kit(LanguageManager.kits.priest.name, Type.ABILITY, "priest",
    ...
    public static Kit siren() {
        Kit kit = new Kit(LanguageManager.kits.siren.name, Type.ABILITY, "siren", Material.COBWEB);
    ...
    public static Kit monk() {
        Kit kit = new Kit(LanguageManager.kits.monk.name, Type.ABILITY, "monk", Material.BELL);
    ...
    public static Kit messenger() {
        Kit kit = new Kit(LanguageManager.kits.messenger.name, Type.ABILITY, "messenger", Material.FEATHER);
    ...
    public static Kit blacksmith() {
        Kit kit = new Kit(LanguageManager.kits.blacksmith.name, Type.EFFECT, "blacksmith", Material.ANVIL);
    ...
    public static Kit witch() {
        Kit kit = new Kit(LanguageManager.kits.witch.name, Type.EFFECT, "witch", Material.CAULDRON);
    ...
    public static Kit merchant() {
        Kit kit = new Kit(LanguageManager.kits.merchant.name, Type.EFFECT, "merchant", Material.EMERALD_BLOCK);
    ...
    public static Kit vampire() {
        Kit kit = new Kit(LanguageManager.kits.vampire.name, Type.EFFECT, "vampire", Material.GHAST_TEAR);
    ...
    public static Kit giant() {
        Kit kit = new Kit(LanguageManager.kits.giant.name, Type.EFFECT, "giant", Material.DARK_OAK_SAPLING);
    ...
    @NotNull
    public static Kit trainer() {
        Kit kit = new Kit(LanguageManager.kits.trainer.name, Type.EFFECT, "trainer", Material.LEAD);

        kit.addLevelDescriptions(1, LanguageManager.kits.trainer.description1);
        kit.addLevelDescriptions(2, LanguageManager.kits.trainer.description2);
