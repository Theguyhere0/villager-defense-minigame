...
import me.theguyhere.villagerdefense.plugin.game.achievements.exceptions.InvalidAchievementReqTypeException;
...
public class Achievement {
    ...
    public static Achievement allChallenges() {
        Achievement achievement = new Achievement(
                ...
                Type.INSTANCE,
                new AchievementReward(AchievementReward.Type.BOOST, BoostRewardID.RESURRECTION)
        );
    ...
    public static Achievement allEffect() {
        Achievement achievement = new Achievement(
                ...
                Type.KIT,
                new AchievementReward(AchievementReward.Type.BOOST, BoostRewardID.SHARE_EFFECT)
    ...
    public static Achievement allKits() {
        Achievement achievement = new Achievement(
                ...
                Type.KIT,
                new AchievementReward(AchievementReward.Type.BOOST, BoostRewardID.TWO_KITS)
    ...
    public static Achievement allMaxedAbility() {
        Achievement achievement = new Achievement(
                ...
                Type.KIT,
                new AchievementReward(AchievementReward.Type.BOOST, BoostRewardID.COOLDOWN_REDUCTION)
        );
    ...
    public static Achievement topBalance9() {
        Achievement achievement = new Achievement(
                ...
                Material.EMERALD,
                Type.HIGH_SCORE,
                new AchievementReward(AchievementReward.Type.BOOST, BoostRewardID.GEM_INCREASE)
        );
    ...
    public static Achievement topKills9() {
        Achievement achievement = new Achievement(
                ...
                Material.ZOMBIE_HEAD,
                Type.HIGH_SCORE,
                new AchievementReward(AchievementReward.Type.BOOST, BoostRewardID.DAMAGE_INCREASE)
        );
    ...
    public static Achievement topWave9() {
        Achievement achievement = new Achievement(
                ...
                Material.GOLDEN_SWORD,
                Type.HIGH_SCORE,
                new AchievementReward(AchievementReward.Type.BOOST, BoostRewardID.HEALTH_INCREASE)
        );
    ...
    public static Achievement totalGems9() {
        Achievement achievement = new Achievement(
                ...
                Material.EMERALD_BLOCK,
                Type.HIGH_SCORE,
                new AchievementReward(AchievementReward.Type.BOOST, BoostRewardID.CRYSTAL_CONVERT)
        );
    ...
    public static Achievement totalKills9() {
        Achievement achievement = new Achievement(
                ...
                Material.DRAGON_HEAD,
                Type.HIGH_SCORE,
                new AchievementReward(AchievementReward.Type.BOOST, BoostRewardID.DAMAGE_REDUCTION)
        );
