...
public abstract class MessengerAbility extends VDAbility {
	private static final String MESSENGER_ABILITY = "messenger-ability";
	...
	public static ItemStack create(Tier tier) {
		...
		persistentTags.put(ITEM_TYPE_KEY, MESSENGER_ABILITY);

		// Set name
		String name;
		switch (tier) {
			case T0:
				name = formatName(LanguageManager.itemLore.essences.t0.name, LanguageManager.kits.messenger.name,
					tier
				);
				break;
			case T1:
				name = formatName(LanguageManager.itemLore.essences.t1.name, LanguageManager.kits.messenger.name,
					tier
				);
				break;
			case T2:
				name = formatName(LanguageManager.itemLore.essences.t2.name, LanguageManager.kits.messenger.name,
					tier
				);
				break;
			case T3:
				name = formatName(LanguageManager.itemLore.essences.t3.name, LanguageManager.kits.messenger.name,
					tier
				);
				break;
			case T4:
				name = formatName(LanguageManager.itemLore.essences.t4.name, LanguageManager.kits.messenger.name,
					tier
				);
				break;
			case T5:
				name = formatName(LanguageManager.itemLore.essences.t5.name, LanguageManager.kits.messenger.name,
					tier
				);
				break;
			default:
		...
		switch (tier) {
			...
			case T1:
				...
				break;
			case T2:
				effect = String.format(LanguageManager.kits.messenger.effect, "+20%" + Constants.UPGRADE + "+40%");
				break;
			case T3:
				effect = String.format(LanguageManager.kits.messenger.effect, "+40%");
				break;
			case T4:
				effect = String.format(LanguageManager.kits.messenger.effect, "+40%" + Constants.UPGRADE + "+60%");
				break;
			case T5:
				effect = String.format(LanguageManager.kits.messenger.effect, "+60%");
				break;
			default:
				effect = null;
		}
