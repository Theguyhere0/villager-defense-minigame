...
public class Mobs {
    ...
    private static void setBoss(Arena arena, LivingEntity livingEntity) {
        ...
        livingEntity.setMetadata(VDMob.VD, new FixedMetadataValue(Main.plugin, arena.getId()));
    ...
    public static void setVillager(Arena arena, Villager villager) {
        ...
        villager.setMetadata(VDMob.VD, new FixedMetadataValue(Main.plugin, arena.getId()));
    }
    ...
    public static void setWolf(Main plugin, Arena arena, VDPlayer vdPlayer, Wolf wolf) {
        ...
        wolf.setBreed(false);
        wolf.setMetadata(VDMob.VD, new FixedMetadataValue(plugin, arena.getId()));
    ...
    public static void setGolem(Main plugin, Arena arena, IronGolem ironGolem) {
        ironGolem.setMetadata(VDMob.VD, new FixedMetadataValue(plugin, arena.getId()));
            ...
            switch (typeRatio.get(r.nextInt(typeRatio.size()))) {
                case "zomb":
                    Bukkit.getScheduler().scheduleSyncDelayedTask(Main.plugin,
                            () -> arena.addMob(new VDZombie(arena, ground)), delay);
                    break;
                case "husk":
                ...
                case "spid":
                    Bukkit.getScheduler().scheduleSyncDelayedTask(Main.plugin,
                            () -> arena.addMob(new VDSpider(arena, ground)), delay);
                    break;
                case "cspd":
