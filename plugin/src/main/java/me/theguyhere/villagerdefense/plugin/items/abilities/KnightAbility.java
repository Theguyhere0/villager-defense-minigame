...
public abstract class KnightAbility extends VDAbility {
	private static final String KNIGHT_ABILITY = "knight-ability";
	...
	public static ItemStack create(Tier tier) {
		...
		persistentTags.put(ITEM_TYPE_KEY, KNIGHT_ABILITY);
		...
		switch (tier) {
			...
			case T1:
				...
				break;
			case T2:
				effect = String.format(LanguageManager.kits.knight.effect, "+10" + Constants.UPGRADE + "+20",
					"+10%" + Constants.UPGRADE + "+20%");
				break;
			case T3:
				effect = String.format(LanguageManager.kits.knight.effect, "+20", "+20%");
				break;
			case T4:
				effect = String.format(LanguageManager.kits.knight.effect, "+20" + Constants.UPGRADE + "+30",
					"+20%" + Constants.UPGRADE + "+30%");
				break;
			case T5:
				effect = String.format(LanguageManager.kits.knight.effect, "+30", "+30%");
				break;
			default:
				effect = null;
		}
	...
	public static boolean matches(ItemStack toCheck) {
		...
		if (value == null)
			return false;
		return KNIGHT_ABILITY.equals(value);
	}
}
