...
public class VDVindicator extends Vindicator {
	public VDVindicator(Location location) {
	...
	protected void registerGoals() {
		...
		goalSelector.addGoal(2, new VDMeleeAttackGoal(this, false, Constants.ATTACK_SPEED_SLOW, 1.5));
