...
public class VDCommandExecutor implements CommandExecutor {
	...
	public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label,
		...
		if (GuardClause.checkArgsLengthMatch(args, 0)) {
		...
		try {
			...
			if (Arrays
				...
				.noneMatch(arg -> GuardClause.checkArg(args, 0, arg.getArg())))
