...
public abstract class VDGolem extends VDMob {
    ...
    protected VDGolem(Arena arena, Golem golem, String name, String lore, AttackType attackType, Material buttonMat) {
        super(lore, attackType);
        mob = golem;
        id = golem.getUniqueId();
        golem.setMetadata(TEAM, Team.VILLAGER.getValue());
