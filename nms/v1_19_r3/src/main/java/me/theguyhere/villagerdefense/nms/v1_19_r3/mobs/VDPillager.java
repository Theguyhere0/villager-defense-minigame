...
import me.theguyhere.villagerdefense.nms.v1_19_r3.goals.VDRangedCrossbowAttackGoal;
...
public class VDPillager extends Pillager {
	public VDPillager(Location location) {
	...
	protected void registerGoals() {
		...
		goalSelector.addGoal(2, new VDRangedCrossbowAttackGoal<>(this, Constants.ATTACK_INTERVAL_SLOW, 1,
			(float) (Constants.TARGET_RANGE_FAR)));
		goalSelector.addGoal(3, new WaterAvoidingRandomStrollGoal(this, 1));
		goalSelector.addGoal(4, new RandomLookAroundGoal(this));

		// Target priorities
		targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, Villager.class, true));
	...
	public void performRangedAttack(LivingEntity var0, float var1) {
		performCrossbowAttack(this, 2.5f);
	}
