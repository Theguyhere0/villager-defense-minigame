...
import me.theguyhere.villagerdefense.plugin.entities.mobs.minions.VDMinion;
import me.theguyhere.villagerdefense.plugin.entities.mobs.villagers.VDNormalVillager;
...
/**
 * A class to generate the spawn sequence for monsters and villagers.
 */
public class ArenaSpawnGenerator {
	/**
	...
	private static String findNextType(
		int valueLeftToSpawn, HashMap<String, Double> targetRatio,
