...
public abstract class WarriorAbility extends VDAbility {
	private static final String WARRIOR_ABILITY = "warrior-ability";
	...
	public static ItemStack create(Tier tier) {
		...
		persistentTags.put(ITEM_TYPE_KEY, WARRIOR_ABILITY);
		...
		switch (tier) {
			...
			case T1:
				...
				break;
			case T2:
				effect = String.format(LanguageManager.kits.warrior.effect, "+10%" + Constants.UPGRADE + "+20%");
				break;
			case T3:
				effect = String.format(LanguageManager.kits.warrior.effect, "+20%");
				break;
			case T4:
				effect = String.format(LanguageManager.kits.warrior.effect, "+20%" + Constants.UPGRADE + "+30%");
				break;
			case T5:
	...
	public static boolean matches(ItemStack toCheck) {
		...
		if (value == null)
			return false;
		return WARRIOR_ABILITY.equals(value);
	}
}
