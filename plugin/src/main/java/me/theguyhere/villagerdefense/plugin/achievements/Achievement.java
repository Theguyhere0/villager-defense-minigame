...
public class Achievement {
	...
	private String[] getDescription(boolean obtained) {
		...
		descriptions.add("");
		descriptions.addAll(CommunicationManager.formatDescriptionList(
			obtained ? ChatColor.AQUA : ChatColor.GREEN,
			reward.getType() == AchievementReward.Type.BOOST ? reward.getDescription() :
				CommunicationManager.format(reward.getDescription(), Integer.toString(reward.getValue())),
			Constants.LORE_CHAR_LIMIT
		));
	...
	public boolean equals(Object o) {
		...
		return conjunctive == that.conjunctive && Objects.equals(name, that.name) && Objects.equals(
			description,
			that.description
		) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash(name, description, ID, buttonMaterial, type, requirements, reward, conjunctive);
	}
	...
	public static @NotNull Achievement allAbility() {
		Achievement achievement = new Achievement(
			...
			Type.KIT,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 3000)
		);
	...
	public static @NotNull Achievement allChallenges() {
		Achievement achievement = new Achievement(
			...
			Type.INSTANCE,
			new AchievementReward(AchievementReward.Type.BOOST, AchievementReward.Boost.RESURRECTION)
		);
	...
	public static @NotNull Achievement allGift() {
		Achievement achievement = new Achievement(
			...
			Type.KIT,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 1000)
		);
	...
	public static @NotNull Achievement allMaxedAbility() {
		Achievement achievement = new Achievement(
			...
			Type.KIT,
			new AchievementReward(AchievementReward.Type.BOOST, AchievementReward.Boost.COOLDOWN_REDUCTION)
		);
	...
	public static @NotNull Achievement alone() {
		Achievement achievement = new Achievement(
			...
			Type.INSTANCE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 250)
		);
	...
	public static @NotNull Achievement amputeeAlone() {
		Achievement achievement = new Achievement(
			...
			Material.BAMBOO,
			Type.INSTANCE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 40)
		);
	...
	public static @NotNull Achievement amputeeBalance() {
		Achievement achievement = new Achievement(
			...
			Material.BAMBOO,
			Type.INSTANCE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 100)
		);
	...
	public static @NotNull Achievement amputeeKills() {
		Achievement achievement = new Achievement(
			...
			Material.BAMBOO,
			Type.INSTANCE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 50)
		);
	...
	public static @NotNull Achievement amputeeWave() {
		Achievement achievement = new Achievement(
			...
			Material.BAMBOO,
			Type.INSTANCE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 75)
		);
	...
	public static @NotNull Achievement maxedAbility() {
		Achievement achievement = new Achievement(
			...
			Type.KIT,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 2000),
			false
		);
	...
	public static @NotNull Achievement pacifistUhc() {
		Achievement achievement = new Achievement(
			...
			Type.INSTANCE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 200)
		);
	...
	public static @NotNull Achievement topBalance1() {
		Achievement achievement = new Achievement(
			...
			Material.EMERALD,
			Type.HIGH_SCORE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 5)
		);
	...
	public static @NotNull Achievement topBalance2() {
		Achievement achievement = new Achievement(
			...
			Material.EMERALD,
			Type.HIGH_SCORE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 10)
		);
	...
	public static @NotNull Achievement topBalance3() {
		Achievement achievement = new Achievement(
			...
			Material.EMERALD,
			Type.HIGH_SCORE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 20)
		);
	...
	public static @NotNull Achievement topBalance5() {
		Achievement achievement = new Achievement(
			...
			Material.EMERALD,
			Type.HIGH_SCORE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 80)
		);
	...
	public static @NotNull Achievement topBalance6() {
		Achievement achievement = new Achievement(
			...
			Material.EMERALD,
			Type.HIGH_SCORE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 160)
		);
	...
	public static @NotNull Achievement topBalance7() {
		Achievement achievement = new Achievement(
			...
			Material.EMERALD,
			Type.HIGH_SCORE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 320)
		);
	...
	public static @NotNull Achievement topBalance8() {
		Achievement achievement = new Achievement(
			...
			Material.EMERALD,
			Type.HIGH_SCORE,
			new AchievementReward(AchievementReward.Type.CRYSTAL, 640)
		);
	...
	public static @NotNull Achievement topBalance9() {
		Achievement achievement = new Achievement(
			...
			Material.EMERALD,
			Type.HIGH_SCORE,
			new AchievementReward(AchievementReward.Type.BOOST, AchievementReward.Boost.GEM_INCREASE)
		);
	...
	public static @NotNull Achievement topKills9() {
		Achievement achievement = new Achievement(
			...
			Material.ZOMBIE_HEAD,
			Type.HIGH_SCORE,
			new AchievementReward(AchievementReward.Type.BOOST, AchievementReward.Boost.DAMAGE_INCREASE)
		);
	...
	public static @NotNull Achievement topWave9() {
		Achievement achievement = new Achievement(
			...
			Material.GOLDEN_SWORD,
			Type.HIGH_SCORE,
			new AchievementReward(AchievementReward.Type.BOOST, AchievementReward.Boost.HEALTH_INCREASE)
		);
	...
	public static @NotNull Achievement totalGems9() {
		Achievement achievement = new Achievement(
			...
			Material.EMERALD_BLOCK,
			Type.HIGH_SCORE,
			new AchievementReward(AchievementReward.Type.BOOST, AchievementReward.Boost.CRYSTAL_CONVERT)
		);
