...
public class VDGhast extends Ghast {
	...
	protected void registerGoals() {
		...
		goalSelector.addGoal(1, new VDGhastAttackGoal(this, Constants.TARGET_RANGE_FAR,
			Constants.ATTACK_INTERVAL_VERY_SLOW * Constants.ATTACK_INTERVAL_RANGED_MULTIPLIER
		));
	...
	public AttributeMap getAttributes() {
		return new AttributeMap(Monster
			...
			.add(Attributes.ATTACK_SPEED, Constants.ATTACK_INTERVAL_VERY_SLOW * Constants.ATTACK_INTERVAL_RANGED_MULTIPLIER)
